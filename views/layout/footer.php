  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
		...
		<div class="social-links-warp">
			<div class="container">
				<div class="social-links">
					<a href="#"><i class="fa fa-telegram"></i><span>telegram</span></a>
	...
	<!--====== Javascripts & Jquery ======-->
	<script src="<?=$s['base']['url']?>js/jquery-3.2.1.min.js"></script>
	<script src="<?=$s['base']['url']?>js/bootstrap.min.js"></script>
	<script src="<?=$s['base']['url']?>js/jquery.slicknav.js"></script>
	<script src="<?=$s['base']['url']?>js/owl.carousel.min.js"></script>
	<script src="<?=$s['base']['url']?>js/circle-progress.min.js"></script>
	<script src="<?=$s['base']['url']?>js/jquery.magnific-popup.min.js"></script>
	<script src="<?=$s['base']['url']?>js/main.js"></script>
