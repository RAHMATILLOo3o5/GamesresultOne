	...
	<!-- Banner section -->
	<section class="banner-section set-bg" data-setbg="img/video_bg.jpg">
		<div class="container">
			<div class="banner-text">
				<div class="banner-logo">
					<h6>Spring Special Offer</h6>
					<img src="img/games.png" class="logo_img">
				</div>
				<p class="text-dark">Vestibulum malesuada aliquet libero viverra cursus. Aliquam erat volutpat. Morbi id dictum quam, ut commodo lorem. In at nisi nec arcu porttitor aliquet vitae at dui. Sed sollicitudin nulla non leo viverra scelerisque.</p>
